        ...
        <a href="<?php echo e(route('jobs.index',  $connection->id)); ?>" class="btn btn-sm btn-primary"><i data-feather="skip-back"></i>Back</a>
            ...
            <div class="container">
                <div class="row ">
                    <div class="col"></div>
                    <div class="col-md-8">
                        <form action="<?php echo e(route('insert.store',  $connection->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php endif; ?><?php /**PATH C:\wamp64\www\SuperDB\resources\views/insert/index.blade.php ENDPATH**/ ?>