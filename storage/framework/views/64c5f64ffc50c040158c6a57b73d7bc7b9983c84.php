      ...
      <div class="sidebar-start">
          ...
          <div class="sidebar-body">
              <ul class="sidebar-body-menu">
                  ...
                  <li>
                      <a class="<?php if(Request::is('dashboard')): ?> active <?php endif; ?>" href="<?php echo e(route('super-db.dashboard')); ?>"><span
                          class="icon home" aria-hidden="true"></span><?php echo e(__('Dashboard')); ?></a>
                  </li>
  
                  <li>
                      <a class="<?php if(Request::is('connection')): ?> active <?php endif; ?>" href="<?php echo e(route('super-db.connection.index')); ?>"><span
                          class="icon setting" aria-hidden="true"></span><?php echo e(__('Connection')); ?></a>
                  </li>
                  <li>
                  ...
                  <li>
                      <a class="show-cat-btn <?php if(Request::is('register')): ?>  || (Request::is('roles')) active <?php endif; ?> " href="##" >
                          <span class="icon user-3" aria-hidden="true"></span><?php echo e(__('Admin')); ?>

                          <span class="category__btn transparent-btn" title="Open list">
                              <span class="sr-only"><?php echo e(__('Open list')); ?></span>
      ...
      <div class="sidebar-footer">
          <a href="" class="sidebar-user">
              ...
              <div class="sidebar-user-info">
                  <span class="sidebar-user__title"><?php echo e(Auth::user()->fullname); ?></span>
                  <span class="sidebar-user__subtitle"><?php echo e(Auth::user()->type); ?></span>
              </div>
            </a>
            ...
            <div>
              ...
              <div>
                <a class="nav-link  dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                    <li>
                        <a class="dropdown-item" onclick="document.getElementById('logoutform').submit()" href=""><i data-feather="log-out"aria-hidden="true"></i><?php echo e(__('Logout')); ?></a></li>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li>
                        ...
                        <li class="lang-switcher-wrapper">
                            ...
                            <ul class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                            <li>
                                <button class="dropdown-item" onclick="document.getElementById('logoutform').submit()" href=""><i data-feather="log-out"aria-hidden="true"></i><?php echo e(__('Logout')); ?></button></li>
                            
                            <form action="<?php echo e(route('log')); ?>" id="logoutform" method="post">
                                <?php echo csrf_field(); ?>
