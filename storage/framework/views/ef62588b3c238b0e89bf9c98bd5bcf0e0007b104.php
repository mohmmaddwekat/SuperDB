  ...
  <?php if(sizeof($connections) > 0): ?> 
   <?php $__currentLoopData = $connections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $connection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><a type="button" href="<?php echo e(route('connection.delete', $connection->id )); ?>" class="btn btn-danger"><?php echo e(__('Delete')); ?></a>
        <a type="button" href="<?php echo e(route('jobs.index', $connection->id )); ?>" class="btn btn-primary"><?php echo e(__('Show')); ?></a></td>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\SuperDB\resources\views/connection.blade.php ENDPATH**/ ?>