...
<?php $component->withAttributes([]); ?>
  ...
  ?>
    ...
    <div class="d-grid gap-2 d-md-block">
        <?php if(in_array('super-db.connection.index',$roles_Abilitiles)): ?>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <?php if(in_array('super-db.import.index',$roles_Abilitiles)): ?>
        ...
        <?php endif; ?>
        <?php if(in_array('super-db.versionControl.index',$roles_Abilitiles)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-grid gap-2 d-md-flex ">
                                <?php if(in_array('super-db.jobs.view-column',$roles_Abilitiles)): ?>
                                ...
                                <?php endif; ?>
                                <?php if(in_array('super-db.jobs.delete-table',$roles_Abilitiles)): ?>            
                                ...
                                <?php endif; ?>
                                <?php if(in_array('super-db.inserts.rename-table',$roles_Abilitiles)): ?>     
