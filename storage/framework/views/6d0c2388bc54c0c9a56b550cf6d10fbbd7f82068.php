...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-grid gap-2 d-md-block">
        <a href="<?php echo e(route('connection.index')); ?>" class="btn btn-sm btn-primary"><i
                data-feather="skip-back"></i><?php echo e(__('Back')); ?></a>
        <a href="<?php echo e(route('sqls.index', $connection->id)); ?>"><button class="btn btn-primary"
                type="button">Sql</button></a>
        <a href="<?php echo e(route('inserts.index', $connection->id)); ?>"><button class="btn btn-primary"
                type="button"><?php echo e(__('Insert')); ?></button></a>
    </div>

    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="<?php echo e(route('import.index', $connection->id)); ?>" class="mr-2"><button class="btn btn-primary" type="button"><?php echo e(__('Import')); ?></button></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center">
                    <a href="<?php echo e(route('db.export', [$connection->id, 'sql'])); ?>" class="mx-2"><button
                            class="btn btn-primary" type="button">Sql <?php echo e(__('File')); ?></button></a>
                    <a href="<?php echo e(route('db.export', [$connection->id, 'csv'])); ?>"><button class="btn btn-primary"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-grid gap-2 d-md-flex ">
                                <a href="<?php echo e(route('jobs.view-column', [$table, $connection->id])); ?>"><button
                                        class="btn btn-primary" type="button"><?php echo e(__('Show')); ?></button></a>
                                <form action="<?php echo e(route('jobs.delete-table', [$connection->id, $table])); ?>" method="post"
                                    class="mx-2">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('delete'); ?>
                                    <button type="submit" class="btn btn-danger"><?php echo e(__('Delete')); ?></button>
                                </form>
                                <a href="<?php echo e(route('inserts.rename-table', [$connection->id, $table])); ?>"><button
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\SuperDB\resources\views/jobs/index.blade.php ENDPATH**/ ?>