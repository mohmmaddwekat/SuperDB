        ...
        <a href="<?php echo e(route('jobs.index',  $connection->id)); ?>" class="btn btn-sm btn-primary"><i data-feather="skip-back"></i>Back</a>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100 mt-5">
                <div class="col col-md-12 col-lg-8 col-xl-6">
                    <form action="<?php echo e(route('jobs.store', $connection->id)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\SuperDB\resources\views/jobs/sql.blade.php ENDPATH**/ ?>