...
<?php $component->withAttributes([]); ?>
    <div class="d-grid gap-2 d-md-block">
        ...
        <div class="container">
                <div class="row ">
                    <div class="col-md-8">
                        <form action="<?php echo e(route('super-db.inserts.updateTable',  [$connection->id,$table])); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php endif; ?><?php /**PATH C:\wamp64\www\SuperDB\resources\views/super-db/inserts/renameTable.blade.php ENDPATH**/ ?>