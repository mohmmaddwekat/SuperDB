        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
            <div class="col-5">
                <select class="form-select" name="type" aria-label="Default select example">
                    ...
                    <option value="txt">Text <?php echo e(__('File')); ?></option>
                    <option value="sql">SQL <?php echo e(__('File')); ?></option>
                </select>
            </div>
        </div>
    <div class="d-grid gap-2 d-md-flex justify-content-md-end"> 
        <label for="formFile" class="form-label"><span class="font-weight-normal"><?php echo e(__('Browse your computer:')); ?></span></label>
