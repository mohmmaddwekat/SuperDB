...
unset($__errorArgs, $__bag); ?> " >
                              ...
                              <div class="form-group">
                                  <label  class="form-label "><?php echo e(__('Type of admin')); ?></label>
...
unset($__errorArgs, $__bag); ?>" >
                                      <option  value=""><?php echo e(__('Choose Type of admin')); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="">
                                    <option value=""><?php echo e(__('No role')); ?></option>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role['id']); ?>" <?php if($role->id == old('role_id')): ?> selected <?php endif; ?>><?php echo e(__($role['name'])); ?></option>
