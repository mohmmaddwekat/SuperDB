        ...
        <a href="<?php echo e(route('super-db.jobs.index',  $connection->id)); ?>" class="btn btn-sm btn-primary"><i data-feather="skip-back"></i><?php echo e(__('Back')); ?></a>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100 mt-5">
                <div class="col col-md-12 col-lg-8 col-xl-6">
                    <form action="<?php echo e(route('super-db.sqls.store', $connection->id)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\SuperDB\resources\views/super-db/sqls/index.blade.php ENDPATH**/ ?>